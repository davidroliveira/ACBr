...
public interface ACBrAACInterop extends InteropLib {
	...
	int AAC_IdentPaf_GetDataLaudo(int aacHandle, DoubleByReference dataLaudo);
	...
	int AAC_IdentPaf_Paf_GetPerfilRequisitos(int aacHandle, ByteBuffer buffer, int bufferLen);
	...
	int AAC_IdentPaf_Paf_SetPerfilRequisitos(int aacHandle, String perfil);
	...
	int AAC_IdentPaf_SetDataLaudo(int aacHandle, double dataLaudo);
