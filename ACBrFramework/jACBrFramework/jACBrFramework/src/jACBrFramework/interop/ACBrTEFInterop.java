...
public interface ACBrTEFInterop extends InteropLib {
	...
	public interface InfoECFCallback extends com.sun.jna.Callback {
		void invoke(int Operacao, Pointer pRetornoECF, int pRetornoECFLen);
	}
	...
	public interface TEFCliSiTefExibeMenuCallback extends com.sun.jna.Callback {
		void invoke(String pTitulo, IntByReference pOpcoes, int pOpcoesCount, IntByReference pItemSelecionado, IntByReference pVoltarMen);
	}
	public interface TEFCliSiTefObtemCampoCalback extends com.sun.jna.Callback {
		void invoke(String pTitulo, int pTamanhoMinimo, int pTamanhoMaximo, int pTipoCampo,
	...
	public interface TEFVeSPagueObtemCampoCalback extends com.sun.jna.Callback {
		void invoke(String pTitulo, String pMascara, char pTipo, ByteBuffer pResposta, IntByReference pDigitado);
	}
	...
	int TEF_Inicializado(int tefHandle, int GP);
	...
	int TEF_Req_GravaInformacao(int tefHandle, int reqHandle, int Identificacao, int Sequencia, String Informacao);
	...
	int TEF_Resp_GetCodigoAutorizacaoTransacao(int tefHandle, int respHandle, ByteBuffer buffer, int bufferLen);
	...
	int TEF_TEFCliSiTef_GetArqLOG(int tefHandle, ByteBuffer buffer, int bufferLen);
	int TEF_TEFCliSiTef_GetCodigoLoja(int tefHandle, ByteBuffer buffer, int bufferLen);
	int TEF_TEFCliSiTef_GetDataHoraFiscal(int tefHandle, DoubleByReference DataHoraFiscal);
	int TEF_TEFCliSiTef_GetDocumentoFiscal(int tefHandle, ByteBuffer buffer, int bufferLen);
	int TEF_TEFCliSiTef_GetEnderecoIP(int tefHandle, ByteBuffer buffer, int bufferLen);
	int TEF_TEFCliSiTef_GetExibirErroRetorno(int tefHandle);
	int TEF_TEFCliSiTef_GetHabilitado(int tefHandle);
	int TEF_TEFCliSiTef_GetLogDebug(int tefHandle);
	...
	int TEF_TEFCliSiTef_GetPortaPinPad(int tefHandle);
	int TEF_TEFCliSiTef_GetRestricoes(int tefHandle, ByteBuffer buffer, int bufferLen);
	int TEF_TEFCliSiTef_GetUsaUTF8(int tefHandle);
	int TEF_TEFCliSiTef_ObtemQuantidadeTransacoesPendentes(int tefHandle, double data, String cupom);
	int TEF_TEFCliSiTef_SetArqLOG(int tefHandle, String ArqLOG);
	int TEF_TEFCliSiTef_SetCodigoLoja(int tefHandle, String CodigoLoja);
	int TEF_TEFCliSiTef_SetDataHoraFiscal(int tefHandle, double DataHoraFiscal);
	int TEF_TEFCliSiTef_SetDocumentoFiscal(int tefHandle, String DocumentoFiscal);
	int TEF_TEFCliSiTef_SetEnderecoIP(int tefHandle, String EnderecoIP);
	int TEF_TEFCliSiTef_SetExibirErroRetorno(int tefHandle, boolean ExibirErroRetorno);
	int TEF_TEFCliSiTef_SetHabilitado(int tefHandle, boolean Habilitado);
	int TEF_TEFCliSiTef_SetLogDebug(int tefHandle, boolean LogDebug);
	...
	int TEF_TEFCliSiTef_SetPortaPinPad(int tefHandle, int PortaPinPad);
	int TEF_TEFCliSiTef_SetRestricoes(int tefHandle, String Restricoes);
	int TEF_TEFCliSiTef_SetUsaUTF8(int tefHandle, boolean UsaUTF8);
