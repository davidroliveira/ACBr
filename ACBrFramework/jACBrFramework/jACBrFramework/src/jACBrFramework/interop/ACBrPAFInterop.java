...
public interface ACBrPAFInterop extends InteropLib {
	...
	public static class RegistroMercadoriasRec extends Structure implements Structure.ByValue {
        ...
        public static class RegistroJ1Rec extends Structure implements Structure.ByValue {
                public int    QTD_J2;
		public byte[] CNPJ = new byte[15];
    		public double DATA_EMISSAO;
    		public double SUBTOTAL;
    		public double DESC_SUBTOTAL;
    		public byte[] INDICADOR_DESC = new byte[2];
    		public double ACRES_SUBTOTAL;
    		public byte[] INDICADOR_ACRES = new byte[2];
    		public double VALOR_LIQUIDO;
    		public byte[] INDICADOR_CANC = new byte[2];
    		public double VAL_CANC_ACRES;
    		public byte[] ORDEM_APLIC_DES_ACRES = new byte[2];
    		public byte[] NOME_CLIENTE = new byte[41];
    		public byte[] CPFCNPJ_CLIENTE = new byte[15];
    		public byte[] NUMERO_NOTA = new byte[11];
    		public byte[] SERIE_NOTA = new byte[4];
    		public byte[] CHAVE_NF = new byte[45];
    		public byte[] TIPO_DOC = new byte[2];
    		public byte RegistroValido;
                
		@Override
		protected List<String> getFieldOrder() {
			return Arrays.asList("QTD_J2", "CNPJ" , "DATA_EMISSAO" , "SUBTOTAL", "DESC_SUBTOTAL" , "INDICADOR_DESC" , "ACRES_SUBTOTAL" , 
                                "INDICADOR_ACRES", "VALOR_LIQUIDO", "INDICADOR_CANC", "VAL_CANC_ACRES", "ORDEM_APLIC_DES_ACRES", "NOME_CLIENTE", 
                                "CPFCNPJ_CLIENTE", "NUMERO_NOTA", "SERIE_NOTA", "CHAVE_NF", "TIPO_DOC", "RegistroValido");
		}
                
		public static class ByReference extends RegistroJ1Rec implements Structure.ByReference { }
		public static class ByValue extends RegistroJ1Rec implements Structure.ByValue { }
	}
        
        public static class RegistroJ2Rec extends Structure implements Structure.ByValue {
                public byte[] CNPJ = new byte[15];
                public double DATA_EMISSAO;
                public byte[] NUMERO_ITEM  = new byte[4];
                public byte[] CODIGO_PRODUTO = new byte[15];
                public byte[] DESCRICAO = new byte[101];
                public double QUANTIDADE;
                public byte[] UNIDADE = new byte[4];
                public double VALOR_UNITARIO;
                public double DESCONTO_ITEM;
                public double ACRESCIMO_ITEM;
                public double VALOR_LIQUIDO;
                public byte[] TOTALIZADOR_PARCIAL = new byte[8];
                public byte[] CASAS_DECIMAIS_QTDE = new byte[2];
                public byte[] CASAS_DECIMAIS_VAL_UNIT = new byte[2];
                public byte[] NUMERO_NOTA = new byte[11];
                public byte[] SERIE_NOTA = new byte[4];
                public byte[] CHAVE_NF = new byte[45];
                public byte[] TIPO_DOC = new byte[2];
		...
		@Override
		protected List<String> getFieldOrder() {
			return Arrays.asList("CNPJ" , "DATA_EMISSAO" , "NUMERO_ITEM", "CODIGO_PRODUTO" , "DESCRICAO" , "QUANTIDADE" , 
                                "UNIDADE" , "VALOR_UNITARIO" , "DESCONTO_ITEM" , "ACRESCIMO_ITEM" , "VALOR_LIQUIDO" , "TOTALIZADOR_PARCIAL" , 
                                "CASAS_DECIMAIS_QTDE" , "CASAS_DECIMAIS_VAL_UNIT" , "NUMERO_NOTA" , "SERIE_NOTA" , "CHAVE_NF" , "TIPO_DOC" , "RegistroValido");
		}
	...
	public static class RegistroP2Rec extends Structure implements Structure.ByValue {
		...
		@Override
		protected List<String> getFieldOrder() {
			return Arrays.asList("COD_MERC_SERV" , "CEST" , "NCM" , "DESC_MERC_SERV" , "UN_MED" , "IAT" , "IPPT" , "ST" , "ALIQ" , "VL_UNIT" , "RegistroValido");
		}
	...
	int PAF_Preenche_H(int pafHandle, ACBrPAFInterop.RegistroHD2Rec RegistroH1Rec, ACBrPAFInterop.RegistroH2Rec RegistroH2Rec[], int CountH2);
        int PAF_Preenche_J(int pafHandle, ACBrPAFInterop.RegistroJ1Rec RegistroJ1Rec[], int CountJ1, ACBrPAFInterop.RegistroJ2Rec RegistroJ2Rec[]);
