...
public interface ACBrECFInterop extends InteropLib {
	...
	public interface AbreCupomCallback extends com.sun.jna.Callback {
		void invoke(String cpfCnpj,String nome,String endereco);
	}
	public static class AliquotaRec extends Structure implements Structure.ByReference {
	...
	public static class ComprovanteNaoFiscalRec extends Structure implements Structure.ByReference {
		public byte[] Indice = new byte[4];
	...
	public static class FormaPagamentoRec extends Structure implements Structure.ByReference {
		public byte[] Indice = new byte[4];
		public byte[] Descricao = new byte[30];
		public boolean PermiteVinculado;
		public double Total;
	...
	public static class RelatorioGerencialRec extends Structure implements Structure.ByReference {
		public byte[] Indice = new byte[4];
		public byte[] Descricao = new byte[30];
		public int Contador;
	...
	int ECF_ArquivoMF_Binario_DLL(int ecfHandle, String pathArquivo);
	int ECF_ArquivoMFD_Binario_DLL(int ecfHandle, String pathArquivo);
	int ECF_ArquivoMFD_Binario_DLL_COO(int ecfHandle, String pathArquivo, int cooInicial, int cooFinal);
	int ECF_ArquivoMFD_Binario_DLL_Data(int ecfHandle, String pathArquivo, double dataInicial, double dataFinal);
	int ECF_ArquivoMFD_DLL(int ecfHandle, double daTaInicial, double daTaFinal, String arquivo, int documentos[], int qtdDoc, int finalidade);
	int ECF_ArquivoMFD_DLL_COO(int ecfHandle, int cooInicial, int cooFinal, String arquivo, int documentos[], int qtdDoc, int finalidade, int tipoContador);
	int ECF_Ativar(int ecfHandle);
	int ECF_CancelaCupom(int ecfHandle, int numCooCancelar);
	...
	int ECF_ConfigBarras_GetMargem(int ecfHandle, IntByReference value);
	...
	int ECF_ConfigBarras_SetMargem(int ecfHandle, int value);
	int ECF_ConfigBarras_SetMostrarCodigo(int ecfHandle, boolean value);
	int ECF_Consumidor_AtribuiConsumidor(int ecfHandle, String cpfCnpj, String nome, String endereco);
	...
	int ECF_DAV_Abrir(int ecfHandle, double emissao, String decrdocumento, String numero, String situacao, String vendedor, String observacao, String cpfCnpj, String nome, String endereco, String numFabricacao, String marca, String modelo, String ano, String placa, String renavam, int indice);
	...
	int ECF_EfetuaPagamento(int ecfHandle, String codFormaPagto, double valor, String observacao, boolean imprimeVinculado, int codMeioPagamento);
	...
	int ECF_EspelhoMFD_DLL(int ecfHandle, double daTaInicial, double daTaFinal, String arquivo, int documentos[], int qtdDoc);
	int ECF_EspelhoMFD_DLL_COO(int ecfHandle, int cooInicial, int cooFinal, String arquivo, int documentos[], int qtdDoc);
	...
	int ECF_GetQuebraLinhaRodape(int ecfHandle);
	...
	int ECF_InfoRodapeCupom_Imposto_GetModoCompacto(int ecfHandle);
	...
	int ECF_InfoRodapeCupom_Imposto_GetValorAproximadoEstadual(int ecfHandle, DoubleByReference value);
	int ECF_InfoRodapeCupom_Imposto_GetValorAproximadoFederal(int ecfHandle, DoubleByReference value);
	int ECF_InfoRodapeCupom_Imposto_GetValorAproximadoMunicipal(int ecfHandle, DoubleByReference value);
	int ECF_InfoRodapeCupom_Imposto_SetFonte(int ecfHandle, String mesa);
	int ECF_InfoRodapeCupom_Imposto_SetModoCompacto(int ecfHandle, boolean imprimir);
	...
	int ECF_InfoRodapeCupom_Imposto_SetValorAproximadoEstadual(int ecfHandle, double value);
	int ECF_InfoRodapeCupom_Imposto_SetValorAproximadoFederal(int ecfHandle, double value);
	int ECF_InfoRodapeCupom_Imposto_SetValorAproximadoMunicipal(int ecfHandle, double value);
	...
	int ECF_InfoRodapeCupom_PostoCombustivel_Clear(int ecfHandle);
	int ECF_InfoRodapeCupom_PostoCombustivel_GetAutomatico(int ecfHandle, int abaHandle);
	int ECF_InfoRodapeCupom_PostoCombustivel_GetBico(int ecfHandle, int abaHandle);
	int ECF_InfoRodapeCupom_PostoCombustivel_GetEF(int ecfHandle, int abaHandle, DoubleByReference value);
	int ECF_InfoRodapeCupom_PostoCombustivel_GetEI(int ecfHandle, int abaHandle, DoubleByReference value);
	int ECF_InfoRodapeCupom_PostoCombustivel_GetImprimir(int ecfHandle);
	int ECF_InfoRodapeCupom_PostoCombustivel_GetVolume(int ecfHandle, int abaHandle, DoubleByReference value);
	int ECF_InfoRodapeCupom_PostoCombustivel_New(int ecfHandle, IntByReference abaHandle);
	int ECF_InfoRodapeCupom_PostoCombustivel_Remove(int ecfHandle, int abaHandle);
	int ECF_InfoRodapeCupom_PostoCombustivel_SetAutomatico(int ecfHandle, int abaHandle, boolean value);
	int ECF_InfoRodapeCupom_PostoCombustivel_SetBico(int ecfHandle, int abaHandle, int value);
	int ECF_InfoRodapeCupom_PostoCombustivel_SetEF(int ecfHandle, int abaHandle, double value);
	int ECF_InfoRodapeCupom_PostoCombustivel_SetEI(int ecfHandle, int abaHandle, double value);
	int ECF_InfoRodapeCupom_PostoCombustivel_SetImprimir(int ecfHandle, boolean imprimir);
	int ECF_InfoRodapeCupom_PostoCombustivel_SetVolume(int ecfHandle, int abaHandle, double value);
	...
	int ECF_PafMF_ArqMF_Binario(int ecfHandle, String pathArquivo, boolean assinar);
	int ECF_PafMF_ArqMFD_Binario(int ecfHandle, String pathArquivo, double dataInicial, double dataFinal, boolean assinar);
	...
	int ECF_PafMF_RelDAVEmitidos(int ecfHandle, DAVsRec daVs[], int index, String tituloRelatorio, int indiceRelatorio);
	...
	int ECF_SetQuebraLinhaRodape(int ecfHandle, boolean aguardaImpressao);
	...
	int ECF_VendeItemEx(int ecfHandle, String codigo, String descricao, String aliquotaIcms, double qtd, double valorUnitario, double descontoPorc, String unidade, String tipoDescontoAcrescimo, String descontoAcrescimo, int codDepartamento, String ean13, int casasDecimaisQtde, int casasDecimaisValor, char arredondaTrunca, String ncm, String cfop, String informacaoAdicional, double totalDosTributos, int origemProduto, String cstIcms, int modalidadeBcicms, double percentualReducaoBcicms, String csosn, double valorBaseCalculoSn, double valorIcmsRetidoSn, double aliquotaCalculoCreditoSn, double valorCreditoIcmssn, String itemListaServico, String codigoIss, String naturezaOperacaoIss, int indicadorIncentivoFiscalIss, String codigoIbge, int modalidadeBcicmsst, double percentualMargemIcmsst, double percentualReducaoBcicmsst, double valorReducaoBcicmsst, double aliquotaIcmsst, double valorIcmsst, double valorIcmsDesonerado, int motivoDesoneracaoIcms, String CST_PIS, double BaseCalculoPIS, double AliquotaPIS, double ValorPIS, double QuantidadeVendidaPIS, double ValorAliquotaPIS, String CST_COFINS, double BaseCalculoCOFINS, double AliquotaCOFINS, double ValorCOFINS, double QuantidadeVendidaCOFINS, double ValorAliquotaCOFINS, String cest);
}
