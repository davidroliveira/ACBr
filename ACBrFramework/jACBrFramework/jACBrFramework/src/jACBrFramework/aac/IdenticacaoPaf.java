...
public class IdenticacaoPaf extends ACBrAACWrapper {
     ...
     * @throws ACBrException 
     */
    public void setDataLaudo(Date dataLaudo) throws ACBrException {
        int ret = ACBrAACInterop.INSTANCE.AAC_IdentPaf_SetDataLaudo(getHandle(), OleDate.toOADate(dataLaudo));
        checkResult(ret);
    }
     ...
     * @throws ACBrException 
     */
    public Date getDataLaudo() throws ACBrException {
        DoubleByReference returnValue = new DoubleByReference();
        int ret = ACBrAACInterop.INSTANCE.AAC_IdentPaf_GetDataLaudo(getHandle(), returnValue);
        checkResult(ret);
     ...
     * @throws ACBrException 
     */
    public void setPerfil(String perfil) throws ACBrException {
        int ret = ACBrAACInterop.INSTANCE.AAC_IdentPaf_Paf_SetPerfilRequisitos(getHandle(), toUTF8(perfil));
        checkResult(ret);
    }
     ...
     * @throws ACBrException 
     */
    public String getPerfil() throws ACBrException {
		ByteBuffer returnBuffer = ByteBuffer.allocate(STR_BUFFER_LEN);
        int ret = ACBrAACInterop.INSTANCE.AAC_IdentPaf_Paf_GetPerfilRequisitos(getHandle(), returnBuffer, STR_BUFFER_LEN);
        checkResult(ret);
