...
public final class ACBrECF extends ACBrClass {
     ...
     * @param dataInicial data inicial do arquivo.
     * @param dataFinal data final do arquivo.
     * @param assinar arquivo de saida.
     * @throws ACBrException
     */
    public void PafMF_ArqMFD_Binario(String pArquivo, Date dataInicial, Date dataFinal, boolean assinar) throws ACBrException {
        int ret = ACBrECFInterop.INSTANCE.ECF_PafMF_ArqMFD_Binario(getHandle(), toUTF8(pArquivo), OleDate.toOADate(dataInicial), OleDate.toOADate(dataFinal), assinar);
        checkResult(ret);
    }
     ...
     * 
     * @param pArquivo arquivo de saida.
     * @param assinar assina arquivo.
     * @throws ACBrException
     */
    public void PafMF_ArqMF_Binario(String pArquivo, boolean assinar) throws ACBrException {
        int ret = ACBrECFInterop.INSTANCE.ECF_PafMF_ArqMF_Binario(getHandle(), toUTF8(pArquivo), assinar);
        checkResult(ret);
    }

    public void ArquivoMF_Binario_DLL(String pArquivo) throws ACBrException {
        int ret = ACBrECFInterop.INSTANCE.ECF_ArquivoMF_Binario_DLL(getHandle(), toUTF8(pArquivo));
        checkResult(ret);
    }

    public void ArquivoMFD_Binario_DLL(String pArquivo) throws ACBrException {
        int ret = ACBrECFInterop.INSTANCE.ECF_ArquivoMFD_Binario_DLL(getHandle(), toUTF8(pArquivo));
        checkResult(ret);
    }

    public void ArquivoMFD_Binario_DLL(String pArquivo, Date dataInicial, Date dataFinal) throws ACBrException {
        int ret = ACBrECFInterop.INSTANCE.ECF_ArquivoMFD_Binario_DLL_Data(getHandle(), toUTF8(pArquivo), OleDate.toOADate(dataInicial), OleDate.toOADate(dataFinal));
        checkResult(ret);
    }

    public void ArquivoMFD_Binario_DLL(String pArquivo, int cooInicial, int cooFinal) throws ACBrException {
        int ret = ACBrECFInterop.INSTANCE.ECF_ArquivoMFD_Binario_DLL_COO(getHandle(), toUTF8(pArquivo), cooInicial, cooFinal);
        checkResult(ret);
    }
    ...
    public void efetuaPagamento(String codFormaPagto, double valor, String observacao, boolean imprimeVinculado) throws ACBrException {
        efetuaPagamento(codFormaPagto, valor, observacao, imprimeVinculado, 0);
    }

    public void efetuaPagamento(String codFormaPagto, double valor, String observacao, boolean imprimeVinculado, int codMeioPagamento) throws ACBrException {
        int ret = ACBrECFInterop.INSTANCE.ECF_EfetuaPagamento(getHandle(), toUTF8(codFormaPagto), valor, toUTF8(observacao), imprimeVinculado, codMeioPagamento);
        checkResult(ret);
    }
    ...
    public void cancelaCupom(int numCooCancelar) throws ACBrException {
        int ret = ACBrECFInterop.INSTANCE.ECF_CancelaCupom(getHandle(), numCooCancelar);
        checkResult(ret);
    }
    ...
    public void dAV_Abrir(Date emissao, String decrdocumento, String numero, String situacao, String vendedor, String observacao, String cpfCnpj, String nome, String endereco, String numFabricacao, String marca, String modelo, String ano, String placa, String renavam, int indice) throws ACBrException {
        int ret = ACBrECFInterop.INSTANCE.ECF_DAV_Abrir(getHandle(), OleDate.toOADate(emissao), toUTF8(decrdocumento), toUTF8(numero), toUTF8(situacao), toUTF8(vendedor), toUTF8(observacao), toUTF8(cpfCnpj), toUTF8(nome), toUTF8(endereco), toUTF8(numFabricacao), toUTF8(marca), toUTF8(modelo), toUTF8(ano), toUTF8(placa), toUTF8(renavam), indice);
        checkResult(ret);
    }
