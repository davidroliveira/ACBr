 ...
 *
 * @author Jose Mauro
 * @version Criado em: 31/01/2014 12:53:45, revisao: $Id: ProgramTestSpedFiscal.java 12842 2017-01-18 21:59:23Z rfteno $
 */
public class ProgramTestSpedFiscal {
    ...
    public static void main(String[] args) {
        try {
            ...
            Logger.getLogger(ProgramTestSpedFiscal.class.getName()).log(Level.SEVERE, null, ex);
        }        
    }
}