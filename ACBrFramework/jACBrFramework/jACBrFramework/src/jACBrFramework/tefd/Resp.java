 ...
 * 
 * @author Jose Mauro
 * @version Criado em: 27/02/2014 17:27:20, revisao: $Id: Resp.java 12806 2017-01-11 12:53:39Z rfteno $
 */
public class Resp extends ACBrComposedClass {
    ...
    public String getCodigoAutorizacaoTransacao() throws ACBrException {
        ...
        int ret = ACBrTEFInterop.INSTANCE.TEF_Resp_GetCodigoAutorizacaoTransacao(getHandle(), getComposedHandler(), returnBuffer, STR_BUFFER_LEN);
        checkResult(ret);
