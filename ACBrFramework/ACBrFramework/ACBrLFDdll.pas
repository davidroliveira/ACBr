...
function LFD_Create(var lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Destroy(lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_GetUltimoErro(const lfdHandle: PTFDHandle; Buffer: PChar;
...
function LFD_GetAbout(const lfdHandle: PTFDHandle; Buffer: PChar;
  const BufferLen: integer): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_GetArquivo(const lfdHandle: PTFDHandle; Buffer: PChar;
  const BufferLen: integer): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_SetArquivo(const lfdHandle: PTFDHandle; const Arquivo: PChar): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_GetCurMascara(const lfdHandle: PTFDHandle; Buffer: PChar;
  const BufferLen: integer): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_SetCurMascara(const lfdHandle: PTFDHandle;
  const CurMascara: PChar): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_GetPath(const lfdHandle: PTFDHandle; Buffer: PChar;
  const BufferLen: integer): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_SetPath(const lfdHandle: PTFDHandle; const Path: PChar): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_GetDelimitador(const lfdHandle: PTFDHandle; Buffer: PChar;
  const BufferLen: integer): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_SetDelimitador(const lfdHandle: PTFDHandle;
  const Delimitador: PChar): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_GetLinhasBuffer(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_SetLinhasBuffer(const lfdHandle: PTFDHandle;
  const Linhas: integer): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_GetTrimString(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_SetTrimString(const lfdHandle: PTFDHandle;
...
function LFD_GetDT_INI(const lfdHandle: PTFDHandle; var Data: double): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_SetDT_INI(const lfdHandle: PTFDHandle; const Data: double): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_GetDT_FIN(const lfdHandle: PTFDHandle; var Data: double): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_SetDT_FIN(const lfdHandle: PTFDHandle; const Data: double): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;
...
function LFD_IniciaGeracao(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_SaveFileTXT(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;
...
function LFD_SetOnError(const lfdHandle: PTFDHandle;
  const method: TConstStringCallback): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;
...
function LFD_Bloco_0_GetDT_INI(const lfdHandle: PTFDHandle;
  var dtIni: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_SetDT_INI(const lfdHandle: PTFDHandle;
  const dtIni: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_GetDT_FIN(const lfdHandle: PTFDHandle;
  var dtFin: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_SetDT_FIN(const lfdHandle: PTFDHandle;
  const dtFin: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_GetGravado(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0000New(const lfdHandle: PTFDHandle;
  const registro0000: Bloco0Registro0000): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0001New(const lfdHandle: PTFDHandle;
  const registro0001: Bloco0Registro0001): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0005New(const lfdHandle: PTFDHandle;
  const registro0005: Bloco0Registro0005): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0025New(const lfdHandle: PTFDHandle;
  const registro0025: Bloco0Registro0025): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0100New(const lfdHandle: PTFDHandle;
  const registro0100: Bloco0Registro0100): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0150New(const lfdHandle: PTFDHandle;
  const registro0150: Bloco0Registro0150): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0175New(const lfdHandle: PTFDHandle;
  const registro0175: Bloco0Registro0175): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0200New(const lfdHandle: PTFDHandle;
  const registro0200: Bloco0Registro0200): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0205New(const lfdHandle: PTFDHandle;
  const registro0205: Bloco0Registro0205): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0210New(const lfdHandle: PTFDHandle;
  const registro0210: Bloco0Registro0210): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_0_Registro0990_GetQTD_LIN_0(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;
...
function LFD_Bloco_A_GetDT_INI(const lfdHandle: PTFDHandle;
  var dtIni: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_A_SetDT_INI(const lfdHandle: PTFDHandle;
  const dtIni: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_A_GetDT_FIN(const lfdHandle: PTFDHandle;
  var dtFin: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_A_SetDT_FIN(const lfdHandle: PTFDHandle;
  const dtFin: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_A_GetGravado(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_A_RegistroA001New(const lfdHandle: PTFDHandle;
  const registroA001: BlocoARegistroA001): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_A_RegistroA350New(const lfdHandle: PTFDHandle;
  const registroA350: BlocoARegistroA350): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_A_RegistroA360New(const lfdHandle: PTFDHandle;
  const registroA360: BlocoARegistroA360): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_A_RegistroA990_GetQTD_LIN_A(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;
...
function LFD_Bloco_C_GetDT_INI(const lfdHandle: PTFDHandle;
  var dtIni: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_SetDT_INI(const lfdHandle: PTFDHandle;
  const dtIni: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_GetDT_FIN(const lfdHandle: PTFDHandle;
  var dtFin: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_SetDT_FIN(const lfdHandle: PTFDHandle;
  const dtFin: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_GetGravado(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_RegistroC001New(const lfdHandle: PTFDHandle;
  const registroC001: BlocoCRegistroC001): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_RegistroC020New(const lfdHandle: PTFDHandle;
  const registroC020: BlocoCRegistroC020): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_RegistroC550New(const lfdHandle: PTFDHandle;
  const registroC550: BlocoCRegistroC550): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_RegistroC555New(const lfdHandle: PTFDHandle;
  const registroC555: BlocoCRegistroC555): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_RegistroC600New(const lfdHandle: PTFDHandle;
  const registroC600: BlocoCRegistroC600): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_RegistroC605New(const lfdHandle: PTFDHandle;
  const registroC605: BlocoCRegistroC605): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_C_RegistroC990_GetQTD_LIN_C(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;
...
function LFD_Bloco_9_GetDT_INI(const lfdHandle: PTFDHandle;
  var dtIni: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_9_SetDT_INI(const lfdHandle: PTFDHandle;
  const dtIni: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_9_GetDT_FIN(const lfdHandle: PTFDHandle;
  var dtFin: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_9_SetDT_FIN(const lfdHandle: PTFDHandle;
  const dtFin: double): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_9_GetGravado(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_9_Registro9001New(const lfdHandle: PTFDHandle;
  const registro9001: Bloco9Registro9001): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_9_Registro9900New(const lfdHandle: PTFDHandle;
  const registro9900: Bloco9Registro9900): integer; {$IFDEF STDCALL} stdcall;
 {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_9_Registro9990_GetQTD_LIN_9(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;

function LFD_Bloco_9_Registro9999_GetQTD_LIN(const lfdHandle: PTFDHandle): integer;
 {$IFDEF STDCALL} stdcall; {$ENDIF} {$IFDEF CDECL} cdecl; {$ENDIF} export;
...
begin
  ...
  try
    ...
    lfdHandle^.EventHandlers := TEventHandlersLFD.Create();
