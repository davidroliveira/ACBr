...
namespace ACBrFramework.ECF
{
	public interface IACBrECF : IDisposable
	{
		...
		event EventHandler<EventArgs> OnAguardandoRespostaChange;
		...
		event EventHandler<EventArgs> OnAntesAbreCupomVinculado;
		...
		event EventHandler<EventArgs> OnAntesCancelaCupom;
		...
		event EventHandler<EventArgs> OnAntesCancelaNaoFiscal;
		...
		event EventHandler<EventArgs> OnAntesFechaRelatorio;
		...
		event EventHandler<EventArgs> OnAntesLeituraX;
		...
		event EventHandler<EventArgs> OnAntesReducaoZ;
		...
		event EventHandler<EventArgs> OnDepoisAbreCupomVinculado;
		...
		event EventHandler<EventArgs> OnDepoisCancelaCupom;
		...
		event EventHandler<EventArgs> OnDepoisCancelaNaoFiscal;
		...
		event EventHandler<EventArgs> OnDepoisFechaRelatorio;
		...
		event EventHandler<EventArgs> OnDepoisLeituraX;
		...
		event EventHandler<EventArgs> OnDepoisReducaoZ;
		...
		event EventHandler<EventArgs> OnErrorSemPapel;
		...
		void CancelaCupom(int numCooCancelar = 0);
		...
		void EfetuaPagamento(string codFormaPagto, decimal valor, string observacao = "", bool imprimeVinculado = false, int codMeioPagamento = 0);
		...
		void PafMF_ArqMF_Binario(string pathArquivo, bool assinar);

		void PafMF_ArqMFD_Binario(string pathArquivo, DateTime dataInicial, DateTime dataFinal, bool assinar);
		...
		void VendeItemEx(string codigo, string descricao, string aliquotaICMS, decimal qtd,
			...
			int MotivoDesoneracaoICMS = 9, string CST_PIS = "", decimal BaseCalculoPIS = 0,
			decimal AliquotaPIS = 0, decimal ValorPIS = 0, decimal QuantidadeVendidaPIS = 0,
			decimal ValorAliquotaPIS = 0, string CST_COFINS = "", decimal BaseCalculoCOFINS = 0,
			decimal AliquotaCOFINS = 0, decimal ValorCOFINS = 0, decimal QuantidadeVendidaCOFINS = 0,
			decimal ValorAliquotaCOFINS = 0, string CEST = "");
	}
