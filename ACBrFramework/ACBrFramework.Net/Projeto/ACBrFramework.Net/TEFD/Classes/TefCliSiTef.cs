...
namespace ACBrFramework.TEFD
{
	public class TefCliSiTef : ACBrComposedComponent
	{
        ...
        public string ArqLOG
        {
            get
            {
                return GetString(ACBrTEFInterop.TEF_TEFCliSiTef_GetArqLOG);
            }
            set
            {
                SetString(ACBrTEFInterop.TEF_TEFCliSiTef_SetArqLOG, value);
            }
        }
	    ...
	    public DateTime DataHoraFiscal
	    {
	        get
	        {
	            return GetDateTime(ACBrTEFInterop.TEF_TEFCliSiTef_GetDataHoraFiscal);
	        }
	        set
	        {
	            SetDateTime(ACBrTEFInterop.TEF_TEFCliSiTef_SetDataHoraFiscal, value);
	        }
	    }
	    ...
	    public string DocumentoFiscal
	    {
	        get
	        {
	            return GetString(ACBrTEFInterop.TEF_TEFCliSiTef_GetDocumentoFiscal);
	        }
	        set
	        {
	            SetString(ACBrTEFInterop.TEF_TEFCliSiTef_SetDocumentoFiscal, value);
	        }
	    }
        ...
        public bool ExibirErroRetorno
        {
            get
            {
                return GetBool(ACBrTEFInterop.TEF_TEFCliSiTef_GetExibirErroRetorno);
            }
            set
            {
                SetBool(ACBrTEFInterop.TEF_TEFCliSiTef_SetExibirErroRetorno, value);
            }
        }
	    ...
	    public bool LogDebug
	    {
	        get
	        {
	            return GetBool(ACBrTEFInterop.TEF_TEFCliSiTef_GetLogDebug);
	        }
	        set
	        {
	            SetBool(ACBrTEFInterop.TEF_TEFCliSiTef_SetLogDebug, value);
	        }
	    }
        ...
        public int PortaPinPad
        {
            get
            {
                return GetInt32(ACBrTEFInterop.TEF_TEFCliSiTef_GetPortaPinPad);
            }
            set
            {
                SetInt32(ACBrTEFInterop.TEF_TEFCliSiTef_SetPortaPinPad, value);
            }
        }
        ...
        public bool UsaUTF8
        {
            get
            {
                return GetBool(ACBrTEFInterop.TEF_TEFCliSiTef_GetUsaUTF8);
            }
            set
            {
                SetBool(ACBrTEFInterop.TEF_TEFCliSiTef_SetUsaUTF8, value);
            }
        }
