...
namespace ACBrFramework.TEFD
{
	public static class ACBrTEFInterop
	{
		...
		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_Inicializado(IntPtr tefHandle, int GP);
		...
		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_Resp_GetCodigoAutorizacaoTransacao(IntPtr tefHandle, IntPtr respHandle, StringBuilder buffer, int bufferLen);
		...
		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_GetArqLOG(IntPtr tefHandle, StringBuilder buffer, int bufferLen);

		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_SetArqLOG(IntPtr tefHandle, string ArqLOG);
		...
		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_GetDataHoraFiscal(IntPtr tefHandle, ref double DataHoraFiscal);

		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_SetDataHoraFiscal(IntPtr tefHandle, double DataHoraFiscal);

		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_GetDocumentoFiscal(IntPtr tefHandle, StringBuilder buffer, int bufferLen);

		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_SetDocumentoFiscal(IntPtr tefHandle, string DocumentoFiscal);
		...
		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_GetExibirErroRetorno(IntPtr tefHandle);

		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_SetExibirErroRetorno(IntPtr tefHandle, bool ExibirErroRetorno);
		...
		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_GetLogDebug(IntPtr tefHandle);

		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_SetLogDebug(IntPtr tefHandle, bool LogDebug);
		...
		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_GetPortaPinPad(IntPtr tefHandle);

		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_SetPortaPinPad(IntPtr tefHandle, int PortaPinPad);
		...
		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_GetUsaUTF8(IntPtr tefHandle);

		[DllImport(ACBr, CallingConvention = CallingConvention.Cdecl)]
		public static extern int TEF_TEFCliSiTef_SetUsaUTF8(IntPtr tefHandle, bool UsaUTF8);
