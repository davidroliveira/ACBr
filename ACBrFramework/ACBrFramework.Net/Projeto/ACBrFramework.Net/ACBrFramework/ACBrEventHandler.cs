...
namespace ACBrFramework
{
    ...
    internal class ACBrEventHandler<TEventArgs, TCallback> :
        ACBrInteropEventHandlerBase<EventHandler<TEventArgs>, TCallback>
...
#else
    internal class ACBrEventHandler<TCallback> : ACBrInteropEventHandlerBase<EventHandler<EventArgs>, TCallback>
        where TCallback : class
#endif
    {
        #region Constructor
...
#else
        public void Add(EventHandler<EventArgs> value)
#endif
        {
            base.Add(value);
        }
...
#else
        public void Remove(EventHandler<EventArgs> value)
#endif
        {
            base.Remove(value);
        }
