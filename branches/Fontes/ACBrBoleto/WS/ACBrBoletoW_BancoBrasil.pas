...
begin
  ...
  begin
    ...
    Gerador.wCampo(tcStr, '#31', PrefixTag('numeroInscricaoPagador'             ), 00, 15, 1, Sacado.CNPJCPF, DSC_NOME_SACADO);
    ...
    Gerador.wCampo(tcStr, '#40', PrefixTag('numeroInscricaoAvalista'             ), 00, 15, 1, Sacado.SacadoAvalista.CNPJCPF, DSC_NOME_AVALISTA);
