////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//              PCN - Projeto Cooperar DPS                                  //
//                                                                            //
//   Descrição: Classes para geração/leitura dos arquivos xml da NFSe         //
//                                                                            //
...
type
  ...
  TInfoObra = class;
  TInfoDedRed = class;
  TDocDedRedCollection = class;
  TDocDedRedCollectionItem = class;
  TDocOutNFSe = class;
  TDocNFNFS = class;
...
//    property Signature: TSignature read FSignature write FSignature;
  ...
  public
    function Add: TDocDedRedCollectionItem; overload; deprecated {$IfDef SUPPORTS_DEPRECATED_DETAILS} 'Obsoleta: Use a função New'{$EndIf};
  ...
  private
    ...
    FvPis: Currency;
    FvCofins: Currency;
    FtpRetPisCofins: TtpRetPisConfins;
  public
    ...
    property tpRetPisCofins: TtpRetPisConfins read FtpRetPisCofins write FtpRetPisCofins;
  end;
...
function TDocDedRedCollection.Add: TDocDedRedCollectionItem;
begin
  Result := Self.New;
end;
