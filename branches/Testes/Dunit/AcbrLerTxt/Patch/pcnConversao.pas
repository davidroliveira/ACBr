...
type
  ...
  TpcnFormaPagamento = (fpDinheiro, fpCheque, fpCartaoCredito, fpCartaoDebito, fpCreditoLoja,
                        ...
                        fpOutro);
  TpcnBandeiraCartao = (bcNenhum,bcVisa, bcMasterCard, bcAmericanExpress, bcSorocred, bcOutros);
...
begin
  result := EnumeradoToStr(t, ['','01', '02', '03', '04', '99'],
                              [bcNenhum,bcVisa, bcMasterCard, bcAmericanExpress, bcSorocred, bcOutros]);
end;
