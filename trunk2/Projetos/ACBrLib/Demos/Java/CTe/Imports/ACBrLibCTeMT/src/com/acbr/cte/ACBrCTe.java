...
public final class ACBrCTe extends ACBrLibBase implements AutoCloseable {
    ...
    int CTE_ConfigImportar(Pointer libHandler, String eArqConfig);
        
    int CTE_ConfigExportar(Pointer libHandler, ByteBuffer buffer, IntByReference bufferSize);
  ...
  public void ConfigImportar(String eArqConfig) throws Exception {
        ...
        int ret = ACBrCTeLib.INSTANCE.CTE_ConfigImportar(getHandle(), eArqConfig);
        checkResult(ret);
  ...
  public String ConfigExportar() throws Exception {
        ...
        int ret = ACBrCTeLib.INSTANCE.CTE_ConfigExportar(getHandle(), buffer, bufferLen);
        checkResult(ret);
