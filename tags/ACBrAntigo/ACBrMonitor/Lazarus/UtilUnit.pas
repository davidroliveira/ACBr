...
Function AcertaPath(APath : AnsiString): AnsiString;
function Converte(cmd: AnsiString): AnsiString;
Procedure GravaINICrypt(INI : TIniFile; Section, Ident, AString, Pass : AnsiString );
Function LeINICrypt(INI : TIniFile; Section, Ident, Pass : AnsiString) : AnsiString ;
