...
Function Parametro( Texto : AnsiString; Posicao : Integer ) : AnsiString;
Function TraduzObserver( Linhas  : AnsiString ) : AnsiString ;
Function MudaObserverACBr( Comando : AnsiString ) : AnsiString ;
