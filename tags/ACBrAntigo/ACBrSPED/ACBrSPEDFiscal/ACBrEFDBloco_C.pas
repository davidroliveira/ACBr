...
type
  ...
  TRegistroC100 = class
  private
    fIND_OPER: TACBrTipoOpereracao;     /// Indicador do tipo de operação: 0- Entrada; 1- Saída
  ...
  TRegistroC113 = class
  private
    fIND_OPER: TACBrTipoOpereracao; /// Indicador do tipo de operação: 0 - Entrada/aquisição; 1- Saída/prestação
