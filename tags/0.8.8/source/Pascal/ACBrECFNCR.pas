...
procedure TACBrECFNCR.FechaCupom(Observacao: AnsiString);
 Var SL : TStringList ;
     I  : Integer ;
begin
...
procedure TACBrECFNCR.LinhaRelatorioGerencial(Linha: AnsiString);
Var I  : Integer ;
    SL : TStringList ;
begin
...
procedure TACBrECFNCR.FechaNaoFiscal(Observacao: AnsiString);
begin
