...
TACBrECFUrano = class( TACBrECFClass )
 private
    ...
    fsMFD       : Boolean ;
    fsArredonda : Char ;
    fsDocumento : String; { Documento do consumidor. A Urano não utiliza o número
...
begin
  ...
  { Se foi passado o documento do consumidor, guarda o número do documento  }
...
begin
  ...
  Vinculado := ifthen(ImprimeVinculado, '1', '0');
...
begin
  ...
  { *TESTAR* Esta parte tem que ser testada com as alíquotas }
...
begin
  ...
  try
     ...
     begin
        ...
        Descricao := Trim(UpperCase(copy(RetCmd,1,22))) ;
     ...
     begin
        ...
        begin
           ...
           FPagto.PermiteVinculado := (Vinculados.IndexOf(Descricao) >= 0);
...
begin
  EnviaComando('06' + padL(Linha, 480, #0) + R, 35);
end;
...
procedure TACBrECFUrano.ListaRelatorioGerencial(Relatorio: TStrings;
  Vias: Integer);
...
procedure TACBrECFUrano.ListaCupomVinculado(Relatorio: TStrings;
  Vias: Integer);
Var Imp, Linha : Integer ;
    Texto : String ;
begin
