...
Var ErroMsg : String ;
    Erro : Integer ;
begin
                    (*'T4ETETE$1100100000000010000N00%0000UN00000087654321TESTE
                    '             11G000100000000010000N00%0000UN00000876543211TESTE                                 ''*)
  result  := '' ;
  ErroMsg := '' ;
  fpComandoEnviado   := '' ;
  fpRespostaComando  := '' ;
...
begin
  ...
  //Foi incluído um "or" no "if" 301 é o ecf similar porém, duas estações.
  if (pos('201', fsNumVersao) > 0) or (pos('301', fsNumVersao) > 0) then
     CPF_CNPJ := '' ;
