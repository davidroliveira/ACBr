...
begin
  ...
  case AliquotaICMS[1] of
    ...
    'N' : AliquotaStr := 'N00' ;
    'F' : AliquotaStr := 'F00' ;
    'T' : if copy(AliquotaICMS,1,2) = 'TT' then  { Indice  TT01, TT02, TT03}
             AliquotaStr := 'T'+padR(copy(AliquotaICMS,3,2),2,'0')
          else
             AliquotaStr := 'T'+padR(copy(AliquotaICMS,2,2),2,'0') { Indice T01, T02, T03}
  else
   begin
