...
begin
  ...
  begin
     ...
     begin
        if Cursor.X = 1 then
         begin
           TxKeyboard( 217 ) ;   // D9 ou 217 - Apaga linha 1
           TxKeyboard( 219 ) ;   // 219 = comando para teclados antigos
         end
        else
         begin
           TxKeyboard( 218 ) ;   // DA ou 218 - Apaga linha 2
           TxKeyboard( 221 ) ;   // 221 = comando para teclados antigos
         end ;
