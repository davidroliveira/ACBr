...
Function PathWithDelim( APath : String ) : String ;
...
{-----------------------------------------------------------------------------
 ...
 // Valores de Teste: Trunc(1,602 x 0,98)  
 -----------------------------------------------------------------------------}
function TruncFix( X : Double ) : Integer ;
var Fator, ADouble : Double;
begin
//  Result := Trunc( SimpleRoundTo( X, -9) ) ;
//  Substituido pelo codigo abaixo para manter compatibilidade com Lazarus e D5

  Fator   := IntPower(10, -9);
  ADouble := Trunc((X / Fator) + 0.5) * Fator ;
