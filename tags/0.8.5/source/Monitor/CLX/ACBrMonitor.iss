...
#define MyAppVerName "ACBrMonitor-0.6b"
...
LicenseFile=C:\delphi\ACBr\source\Monitor\CLX\licenca.txt
...
Source: TesteTXT.BAT; DestDir: {app}; Flags: ignoreversion; Components: exemplos
Source: leia-me.txt; DestDir: {app}; Flags: ignoreversion isreadme; Components: programa
...
Source: ManualACBrMonitor.html; DestDir: {app}; Flags: ignoreversion; Components: help
Source: ACBrMonitor-change-log.txt; DestDir: {app}; Flags: ignoreversion; Components: help
Source: C:\DELPHI\{#QTDLL}; DestDir: {sys}; Flags: ; Components: programa
Source: C:\DELPHI\inpout32.dll; DestDir: {sys}; Flags: ; Components: programa
...
Name: {group}\Manual do ACBrMonitor; Filename: {app}\ManualACBrMonitor.html; WorkingDir: {app}; Components: help
Name: {group}\Exemplo usando Monitoramento TXT; Filename: {app}\TesteTXT.BAT; WorkingDir: {app}; Components: exemplos
Name: {group}\Ler conteudo do TesteTXT.BAT; Filename: notepad; Parameters: TesteTXT.BAT; WorkingDir: {app}; Components: exemplos
