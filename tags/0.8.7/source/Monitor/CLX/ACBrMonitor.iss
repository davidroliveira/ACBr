...
#define MyAppVerName "ACBrMonitor-0.8.4b"
...
Source: Exemplos\Cobol_socket.zip; DestDir: {app}\Exemplos; Flags: ignoreversion; Components: exemplos
Source: Exemplos\Cobol_ECFACBR.CBL; DestDir: {app}\Exemplos; Flags: ignoreversion; Components: exemplos
