...
begin
  ...
  if ValorDescontoAcrescimo < 0 then
     raise EACBrECFCMDInvalido.Create(
           'ValorDescontoAcrescimo não pode ser negativo');
...
procedure TACBrECF.Sangria(const Valor: Double; Obs: String;
...
procedure TACBrECF.Suprimento(const Valor: Double; Obs: String;
   DescricaoCNF: String; DescricaoFPG: String ) ;
begin
  if DescricaoCNF = '' then
...
Function TACBrECF.LeituraCMC7 : String ;
begin
