...
Function TACBrECFDataRegis.EnviaComando_ECF( cmd : String ) : String ;
Var ErroMsg : String ;
    charAviso:char;
    PediuStatus : Boolean ;
    wRetentar : Boolean ;
...
Function TACBrECFDataRegis.VerificaFimLeitura(var Retorno:String;
...
var Aliquota : TACBrECFAliquota ;
    retCmd, strAliquota, strAux: String;
...
procedure TACBrECFDataRegis.FechaNaoFiscal(Observacao: String);
begin
...
procedure TACBrECFDataRegis.NaoFiscalCompleto(CodCNF: String;
  Valor: Double; CodFormaPagto, Obs: String);
begin
   AbreNaoFiscal();
