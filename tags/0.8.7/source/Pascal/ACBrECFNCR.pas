...
interface
uses ACBrECFClass, ACBrBase, ACBrUtil, Synautil,
     Classes ;
...
TACBrECFNCRComando = class
  private
    ...
    function GetPacoteEnvio: String;
 ...
 public
    ...
    property PacoteEnvio  : String  read GetPacoteEnvio ;
...
function NCRCheckSum(Dados: String): Char;
...
procedure TACBrECFNCRComando.SetComando(const Value: String);
begin
  if fsSeq >= 255 then
     fsSeq := 1
  else
...
procedure TACBrECFNCRComando.AddParam(AString: String);
begin
  fsParams.Add(  AString  ) ;
end;

function TACBrECFNCRComando.GetPacoteEnvio: String;
 Var I : Integer ;
     ParamsStr : String ;
     TBC : Byte;
begin
  ...
  Result := chr( fsSeq ) + Chr( StrToInt(fsComando) ) + Chr( TBC ) + ParamsStr ;
...
procedure TACBrECFNCRResposta.SetResposta(const Value: String);
Var Buf : String ;
    P   : Integer ;
    TamRetorno : Integer;
...
function TACBrECFNCRResposta.GetDescRetorno: String;
...
Function TACBrECFNCR.EnviaComando_ECF( cmd : String = '' ) : String ;
Var ErroMsg    : String ;
    OldTimeOut : Integer ;
    ByteACK    : Byte ;
    ByteSOH    : Byte ;
...
Function TACBrECFNCR.VerificaFimLeitura(var Retorno:String;
...
procedure TACBrECFNCR.FechaCupom(Observacao: String);
 Var SL : TStringList ;
     I  : Integer ;
begin
...
procedure TACBrECFNCR.LinhaRelatorioGerencial(Linha: String);
Var I  : Integer ;
    SL : TStringList ;
begin
...
procedure TACBrECFNCR.LinhaCupomVinculado(Linha: String);
begin
...
procedure TACBrECFNCR.FechaNaoFiscal(Observacao: String);
begin
...
Function TACBrECFNCR.LeituraCMC7 : String ;
begin
  Result :=  '';
