...
Function TACBrECFSweda.VerificaFimLeitura(var Retorno:String;
...
Function TACBrECFSweda.Purge(Id:String) :Boolean ;
 Var RetCmd : String ;
     I : Integer ;
begin
  Result := False ;
...
Var VerInt : Integer ;
    SubModelo, VerString, RetCmd : string ;
begin
...
function TACBrECFSweda.AchaCNFDescricao(
...
begin
  ...
  begin
     ...
     begin
        P := pos( Descricao, UpperCase(Objects[A].Descricao) ) ;
        if (P > 0) and (P < 3) then 
        begin
           result := Objects[A] ;
           Break ;
