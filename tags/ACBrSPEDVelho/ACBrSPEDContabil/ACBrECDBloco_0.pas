...
type
  ...
  private
    ...
    fNOME: AnsiString;        /// Nome empresarial do empresário ou sociedade empresária.
    fCNPJ: AnsiString;        /// Número de inscrição do empresário ou sociedade empresária no CNPJ.
    fUF: AnsiString;          /// Sigla da unidade da federação do empresário ou sociedade empresária.
    fIE: AnsiString;          /// Inscrição Estadual do empresário ou sociedade empresária.
    fCOD_MUN: AnsiString;     /// Código do município do domicílio fiscal do empresário ou sociedade empresária, conforme tabela do IBGE - Instituto Brasileiro de Geografia e Estatística.
    fIM: AnsiString;          /// Inscrição Municipal do empresário ou sociedade empresária.
    fIND_SIT_ESP: AnsiString; /// Indicador de situação especial (conforme tabela publicada pelo Sped).
  public
  ...
  private
    fCOD_ENT_REF: AnsiString; /// Código da instituição responsável pela administração do cadastro (conforme tabela publicada pelo Sped).
    fCOD_INSCR: AnsiString;   /// Código cadastral do empresário ou sociedade empresária na instituição identificada no campo 02.
  public
  ...
  private
    ...
    fCNPJ: AnsiString;        /// Número de inscrição do empresário ou sociedade empresária no CNPJ da matriz ou da filial.
    fUF: AnsiString;          /// Sigla da unidade da federação da matriz ou da filial.
    fIE: AnsiString;          /// Inscrição estadual da matriz ou da filial.
    fCOD_MUN: AnsiString;     /// Código do município do domicílio da matriz ou da filial.
    fIM: AnsiString;          /// Número de Inscrição Municipal da matriz ou da filial.
    fNIRE: AnsiString;        /// Número de Identificação do Registro de Empresas da matriz ou da filial na Junta Comercial.
  public
  ...
  private
    ...
    fNIT: AnsiString;         /// Número de Identificação do Trabalhador, Pis, Pasep, SUS.
    fUF: AnsiString;          /// Sigla da unidade da federação do participante.
    fIE: AnsiString;          /// Inscrição Estadual do participante:
    fIE_ST: AnsiString;       /// Inscrição Estadual do participante na unidade da federação do destinatário, na condição de contribuinte substituto
    fCOD_MUN: integer;        /// Código do município:
    fIM: AnsiString;          /// Inscrição Municipal do participante.
  ...
  private
    fCOD_REL: AnsiString;     /// Código do relacionamento conforme tabela publicada pelo Sped.
