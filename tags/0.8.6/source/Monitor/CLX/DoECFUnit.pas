...
implementation
uses ACBrECF, ACBrBase, ACBrUtil, ACBrECFClass, StrUtils,
        ...
        if Cmd.Metodo = 'ativar' then  { Ativa o ecf }
         ...
         begin
            ...
            ProgramaFormaPagamento( wDescricao ,                   { Descricao }
                   StrToBoolDef(Cmd.Params(1),true),          {Permitevinculado}
                   Cmd.Params(2) ) ;                            { Posicao = '' }
         end
         ...
         begin
          ...
          { O comando acima é util para evitar erros na Impressao de Itens NAO
           ...
           MudaArredondamento( StrToBool(Cmd.Params(0)) )
         ...
         begin
           ...
           PulaLinhas( StrToIntDef( Cmd.Params(0),0) )            { Num.Linhas }
         ...
         begin
           ...
           try
              if pos('/',Cmd.Params(0)) > 0 then
                 ...
                 LeituraMFDSerial(
                     StrToInt(Cmd.Params(0)),                     { COOInicial }
                     StrToInt(Cmd.Params(1)),                       { COOFinal }
                     Linhas ) ;                                      { Retorno }
